...
first_names = [
    ...
    "Hector", "Helena", "Hernan", "Hilda", "Hugo", "Ignacio", "Ines", "Irene", "Isaac", "Isabel",
    ...
    "Marcela", "Marcos", "Margarita", "Mario", "Martina", "Mateo", "Matias", "Mauricio", "Mercedes", "Micaela",
    "Nadia", "Nestor", "Nicolas", "Noelia", "Norberto", "Nuria", "Octavio", "Olga", "Orlando", "Oscar",
    "Pablo", "Paloma", "Patricio", "Paula", "Pedro", "Pilar", "Ramiro", "Raquel", "Ricardo", "Rocio"
]
...
last_names = [
    ...
    "Delgado", "Diaz", "Dominguez", "Duenas", "Duran", "Escobar", "Espinosa", "Estevez", "Estrada", "Fajardo",
    ...
    "Ibanez", "Iglesias", "Infante", "Iturbe", "Jaramillo", "Jimenez", "Juarez", "Lagos", "Lara", "Leon",
    "Lopez", "Luna", "Macias", "Maldonado", "Manrique", "Martinez", "Medina", "Mejia", "Mendoza", "Menendez",
    "Miranda", "Molina", "Montoya", "Morales", "Munoz", "Navarro", "Nieves", "Nieto", "Nunez", "Olivares",
    "Ortega", "Ortiz", "Pacheco", "Padilla", "Palacios", "Paredes", "Parra", "Paz", "Pena", "Perez"
]
...
# Retirer les accents des prenoms et nom de famille
...
def fill_form(driver, your_username, your_password ,your_first_name, your_last_name, your_birthday, your_gender):
    try:driver.get("https://accounts.google.com/signup/v2/createaccount?flowName=GlifWebSignIn&flowEntry=SignUp")
...
month_option = wait.until(EC.element_to_be_clickable((
    By.XPATH, f"//li[@role='option' and @data-value=' {
        int(your_month)}']"
)))
month_option.click()
...
gender_option = wait.until(EC.element_to_be_clickable((
    By.XPATH, f"//li[@role='option' and .//span[text()=' {
        gender_visible_text
    }']]"
)))
...
return f" {
    ...
    birth_date.year
}" # random birthday from 18 to 70 years old, format: "dd mm yyyy"
